...
pub const VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_VERSION_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_VERSION_INFO_KHR);
...
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ACCELERATION_STRUCTURE_FEATURES_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ACCELERATION_STRUCTURE_FEATURES_KHR);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ACCELERATION_STRUCTURE_PROPERTIES_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ACCELERATION_STRUCTURE_PROPERTIES_KHR);
...
pub const VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_BUILD_SIZES_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_BUILD_SIZES_INFO_KHR);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PIPELINE_FEATURES_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PIPELINE_FEATURES_KHR);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PIPELINE_PROPERTIES_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PIPELINE_PROPERTIES_KHR);
...
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_QUERY_FEATURES_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_QUERY_FEATURES_KHR);
...
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PORTABILITY_SUBSET_FEATURES_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PORTABILITY_SUBSET_FEATURES_KHR);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PORTABILITY_SUBSET_PROPERTIES_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PORTABILITY_SUBSET_PROPERTIES_KHR);
...
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_TERMINATE_INVOCATION_FEATURES_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_TERMINATE_INVOCATION_FEATURES_KHR);
...
pub const VK_STRUCTURE_TYPE_FRAGMENT_SHADING_RATE_ATTACHMENT_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_FRAGMENT_SHADING_RATE_ATTACHMENT_INFO_KHR);
pub const VK_STRUCTURE_TYPE_PIPELINE_FRAGMENT_SHADING_RATE_STATE_CREATE_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PIPELINE_FRAGMENT_SHADING_RATE_STATE_CREATE_INFO_KHR);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_PROPERTIES_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_PROPERTIES_KHR);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_FEATURES_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_FEATURES_KHR);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_KHR);
...
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_IMAGE_ATOMIC_INT64_FEATURES_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_IMAGE_ATOMIC_INT64_FEATURES_EXT);
...
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_MEMORY_REPORT_FEATURES_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_MEMORY_REPORT_FEATURES_EXT);
pub const VK_STRUCTURE_TYPE_DEVICE_DEVICE_MEMORY_REPORT_CREATE_INFO_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_DEVICE_DEVICE_MEMORY_REPORT_CREATE_INFO_EXT);
pub const VK_STRUCTURE_TYPE_DEVICE_MEMORY_REPORT_CALLBACK_DATA_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_DEVICE_MEMORY_REPORT_CALLBACK_DATA_EXT);
...
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_ENUMS_PROPERTIES_NV = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_ENUMS_PROPERTIES_NV);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_ENUMS_FEATURES_NV = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_ENUMS_FEATURES_NV);
pub const VK_STRUCTURE_TYPE_PIPELINE_FRAGMENT_SHADING_RATE_ENUM_STATE_CREATE_INFO_NV = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PIPELINE_FRAGMENT_SHADING_RATE_ENUM_STATE_CREATE_INFO_NV);
...
pub const VK_STRUCTURE_TYPE_COPY_COMMAND_TRANSFORM_INFO_QCOM = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_COPY_COMMAND_TRANSFORM_INFO_QCOM);
...
pub const VK_STRUCTURE_TYPE_COPY_BUFFER_INFO_2_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_COPY_BUFFER_INFO_2_KHR);
pub const VK_STRUCTURE_TYPE_COPY_IMAGE_INFO_2_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_COPY_IMAGE_INFO_2_KHR);
pub const VK_STRUCTURE_TYPE_COPY_BUFFER_TO_IMAGE_INFO_2_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_COPY_BUFFER_TO_IMAGE_INFO_2_KHR);
pub const VK_STRUCTURE_TYPE_COPY_IMAGE_TO_BUFFER_INFO_2_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_COPY_IMAGE_TO_BUFFER_INFO_2_KHR);
pub const VK_STRUCTURE_TYPE_BLIT_IMAGE_INFO_2_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_BLIT_IMAGE_INFO_2_KHR);
pub const VK_STRUCTURE_TYPE_RESOLVE_IMAGE_INFO_2_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_RESOLVE_IMAGE_INFO_2_KHR);
pub const VK_STRUCTURE_TYPE_BUFFER_COPY_2_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_BUFFER_COPY_2_KHR);
pub const VK_STRUCTURE_TYPE_IMAGE_COPY_2_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_IMAGE_COPY_2_KHR);
pub const VK_STRUCTURE_TYPE_IMAGE_BLIT_2_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_IMAGE_BLIT_2_KHR);
pub const VK_STRUCTURE_TYPE_BUFFER_IMAGE_COPY_2_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_BUFFER_IMAGE_COPY_2_KHR);
pub const VK_STRUCTURE_TYPE_IMAGE_RESOLVE_2_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_IMAGE_RESOLVE_2_KHR);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_4444_FORMATS_FEATURES_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_4444_FORMATS_FEATURES_EXT);
...
pub const VK_IMAGE_LAYOUT_FRAGMENT_SHADING_RATE_ATTACHMENT_OPTIMAL_KHR = @enumToInt(enum_VkImageLayout.VK_IMAGE_LAYOUT_FRAGMENT_SHADING_RATE_ATTACHMENT_OPTIMAL_KHR);
...
pub const VK_FORMAT_A4R4G4B4_UNORM_PACK16_EXT = @enumToInt(enum_VkFormat.VK_FORMAT_A4R4G4B4_UNORM_PACK16_EXT);
pub const VK_FORMAT_A4B4G4R4_UNORM_PACK16_EXT = @enumToInt(enum_VkFormat.VK_FORMAT_A4B4G4R4_UNORM_PACK16_EXT);
...
pub const VK_DYNAMIC_STATE_RAY_TRACING_PIPELINE_STACK_SIZE_KHR = @enumToInt(enum_VkDynamicState.VK_DYNAMIC_STATE_RAY_TRACING_PIPELINE_STACK_SIZE_KHR);
...
pub const VK_DYNAMIC_STATE_FRAGMENT_SHADING_RATE_KHR = @enumToInt(enum_VkDynamicState.VK_DYNAMIC_STATE_FRAGMENT_SHADING_RATE_KHR);
...
pub const VK_ACCESS_FRAGMENT_SHADING_RATE_ATTACHMENT_READ_BIT_KHR = @enumToInt(enum_VkAccessFlagBits.VK_ACCESS_FRAGMENT_SHADING_RATE_ATTACHMENT_READ_BIT_KHR);
...
pub const VK_FORMAT_FEATURE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR = @enumToInt(enum_VkFormatFeatureFlagBits.VK_FORMAT_FEATURE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR);
...
pub const VK_IMAGE_USAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR = @enumToInt(enum_VkImageUsageFlagBits.VK_IMAGE_USAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR);
...
pub const VK_PIPELINE_STAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR = @enumToInt(enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR);
...
pub const VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_BUILD_INPUT_READ_ONLY_BIT_KHR = @enumToInt(enum_VkBufferUsageFlagBits.VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_BUILD_INPUT_READ_ONLY_BIT_KHR);
pub const VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR = @enumToInt(enum_VkBufferUsageFlagBits.VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR);
pub const VK_BUFFER_USAGE_SHADER_BINDING_TABLE_BIT_KHR = @enumToInt(enum_VkBufferUsageFlagBits.VK_BUFFER_USAGE_SHADER_BINDING_TABLE_BIT_KHR);
...
pub const VK_PIPELINE_CREATE_RAY_TRACING_SHADER_GROUP_HANDLE_CAPTURE_REPLAY_BIT_KHR = @enumToInt(enum_VkPipelineCreateFlagBits.VK_PIPELINE_CREATE_RAY_TRACING_SHADER_GROUP_HANDLE_CAPTURE_REPLAY_BIT_KHR);
...
pub const VK_PERFORMANCE_COUNTER_DESCRIPTION_PERFORMANCE_IMPACTING_BIT_KHR = @enumToInt(enum_VkPerformanceCounterDescriptionFlagBitsKHR.VK_PERFORMANCE_COUNTER_DESCRIPTION_PERFORMANCE_IMPACTING_BIT_KHR);
pub const VK_PERFORMANCE_COUNTER_DESCRIPTION_CONCURRENTLY_IMPACTED_BIT_KHR = @enumToInt(enum_VkPerformanceCounterDescriptionFlagBitsKHR.VK_PERFORMANCE_COUNTER_DESCRIPTION_CONCURRENTLY_IMPACTED_BIT_KHR);
...
pub const struct_VkPhysicalDeviceShaderTerminateInvocationFeaturesKHR = extern struct {
    sType: VkStructureType,
    pNext: ?*c_void,
    shaderTerminateInvocation: VkBool32,
};
pub const VkPhysicalDeviceShaderTerminateInvocationFeaturesKHR = struct_VkPhysicalDeviceShaderTerminateInvocationFeaturesKHR;
pub const VK_FRAGMENT_SHADING_RATE_COMBINER_OP_KEEP_KHR = @enumToInt(enum_VkFragmentShadingRateCombinerOpKHR.VK_FRAGMENT_SHADING_RATE_COMBINER_OP_KEEP_KHR);
pub const VK_FRAGMENT_SHADING_RATE_COMBINER_OP_REPLACE_KHR = @enumToInt(enum_VkFragmentShadingRateCombinerOpKHR.VK_FRAGMENT_SHADING_RATE_COMBINER_OP_REPLACE_KHR);
pub const VK_FRAGMENT_SHADING_RATE_COMBINER_OP_MIN_KHR = @enumToInt(enum_VkFragmentShadingRateCombinerOpKHR.VK_FRAGMENT_SHADING_RATE_COMBINER_OP_MIN_KHR);
pub const VK_FRAGMENT_SHADING_RATE_COMBINER_OP_MAX_KHR = @enumToInt(enum_VkFragmentShadingRateCombinerOpKHR.VK_FRAGMENT_SHADING_RATE_COMBINER_OP_MAX_KHR);
pub const VK_FRAGMENT_SHADING_RATE_COMBINER_OP_MUL_KHR = @enumToInt(enum_VkFragmentShadingRateCombinerOpKHR.VK_FRAGMENT_SHADING_RATE_COMBINER_OP_MUL_KHR);
pub const VK_FRAGMENT_SHADING_RATE_COMBINER_OP_MAX_ENUM_KHR = @enumToInt(enum_VkFragmentShadingRateCombinerOpKHR.VK_FRAGMENT_SHADING_RATE_COMBINER_OP_MAX_ENUM_KHR);
pub const enum_VkFragmentShadingRateCombinerOpKHR = extern enum(c_int) {
...
pub const PFN_vkGetPhysicalDeviceFragmentShadingRatesKHR = ?fn (VkPhysicalDevice, [*c]u32, [*c]VkPhysicalDeviceFragmentShadingRateKHR) callconv(.C) VkResult;
...
pub const PFN_vkCreateDeferredOperationKHR = ?fn (VkDevice, [*c]const VkAllocationCallbacks, [*c]VkDeferredOperationKHR) callconv(.C) VkResult;
pub const PFN_vkDestroyDeferredOperationKHR = ?fn (VkDevice, VkDeferredOperationKHR, [*c]const VkAllocationCallbacks) callconv(.C) void;
pub const PFN_vkGetDeferredOperationMaxConcurrencyKHR = ?fn (VkDevice, VkDeferredOperationKHR) callconv(.C) u32;
pub const PFN_vkGetDeferredOperationResultKHR = ?fn (VkDevice, VkDeferredOperationKHR) callconv(.C) VkResult;
pub const PFN_vkDeferredOperationJoinKHR = ?fn (VkDevice, VkDeferredOperationKHR) callconv(.C) VkResult;
...
pub const VK_SURFACE_COUNTER_VBLANK_BIT_EXT = @enumToInt(enum_VkSurfaceCounterFlagBitsEXT.VK_SURFACE_COUNTER_VBLANK_BIT_EXT);
...
pub const VK_ACCELERATION_STRUCTURE_TYPE_GENERIC_KHR = @enumToInt(enum_VkAccelerationStructureTypeKHR.VK_ACCELERATION_STRUCTURE_TYPE_GENERIC_KHR);
...
pub const struct_VkAccelerationStructureInstanceKHR = opaque {}; // c:/VulkanSDK/1.2.162.0/Include\vulkan/vulkan_core.h:9542:35: warning: struct demoted to opaque type - has bitfield
...
pub const VK_VALIDATION_FEATURE_ENABLE_SYNCHRONIZATION_VALIDATION_EXT = @enumToInt(enum_VkValidationFeatureEnableEXT.VK_VALIDATION_FEATURE_ENABLE_SYNCHRONIZATION_VALIDATION_EXT);
...
pub const VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_ALLOCATE_EXT = @enumToInt(enum_VkDeviceMemoryReportEventTypeEXT.VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_ALLOCATE_EXT);
pub const VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_FREE_EXT = @enumToInt(enum_VkDeviceMemoryReportEventTypeEXT.VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_FREE_EXT);
pub const VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_IMPORT_EXT = @enumToInt(enum_VkDeviceMemoryReportEventTypeEXT.VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_IMPORT_EXT);
pub const VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_UNIMPORT_EXT = @enumToInt(enum_VkDeviceMemoryReportEventTypeEXT.VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_UNIMPORT_EXT);
pub const VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_ALLOCATION_FAILED_EXT = @enumToInt(enum_VkDeviceMemoryReportEventTypeEXT.VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_ALLOCATION_FAILED_EXT);
pub const VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_MAX_ENUM_EXT = @enumToInt(enum_VkDeviceMemoryReportEventTypeEXT.VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_MAX_ENUM_EXT);
pub const enum_VkDeviceMemoryReportEventTypeEXT = extern enum(c_int) {
...
pub const PFN_vkDeviceMemoryReportCallbackEXT = ?fn ([*c]const VkDeviceMemoryReportCallbackDataEXT, ?*c_void) callconv(.C) void;
...
pub const VK_FRAGMENT_SHADING_RATE_TYPE_FRAGMENT_SIZE_NV = @enumToInt(enum_VkFragmentShadingRateTypeNV.VK_FRAGMENT_SHADING_RATE_TYPE_FRAGMENT_SIZE_NV);
pub const VK_FRAGMENT_SHADING_RATE_TYPE_ENUMS_NV = @enumToInt(enum_VkFragmentShadingRateTypeNV.VK_FRAGMENT_SHADING_RATE_TYPE_ENUMS_NV);
pub const VK_FRAGMENT_SHADING_RATE_TYPE_MAX_ENUM_NV = @enumToInt(enum_VkFragmentShadingRateTypeNV.VK_FRAGMENT_SHADING_RATE_TYPE_MAX_ENUM_NV);
pub const enum_VkFragmentShadingRateTypeNV = extern enum(c_int) {
...
pub const VK_FRAGMENT_SHADING_RATE_1_INVOCATION_PER_PIXEL_NV = @enumToInt(enum_VkFragmentShadingRateNV.VK_FRAGMENT_SHADING_RATE_1_INVOCATION_PER_PIXEL_NV);
pub const VK_FRAGMENT_SHADING_RATE_1_INVOCATION_PER_1X2_PIXELS_NV = @enumToInt(enum_VkFragmentShadingRateNV.VK_FRAGMENT_SHADING_RATE_1_INVOCATION_PER_1X2_PIXELS_NV);
pub const VK_FRAGMENT_SHADING_RATE_1_INVOCATION_PER_2X1_PIXELS_NV = @enumToInt(enum_VkFragmentShadingRateNV.VK_FRAGMENT_SHADING_RATE_1_INVOCATION_PER_2X1_PIXELS_NV);
pub const VK_FRAGMENT_SHADING_RATE_1_INVOCATION_PER_2X2_PIXELS_NV = @enumToInt(enum_VkFragmentShadingRateNV.VK_FRAGMENT_SHADING_RATE_1_INVOCATION_PER_2X2_PIXELS_NV);
pub const VK_FRAGMENT_SHADING_RATE_1_INVOCATION_PER_2X4_PIXELS_NV = @enumToInt(enum_VkFragmentShadingRateNV.VK_FRAGMENT_SHADING_RATE_1_INVOCATION_PER_2X4_PIXELS_NV);
pub const VK_FRAGMENT_SHADING_RATE_1_INVOCATION_PER_4X2_PIXELS_NV = @enumToInt(enum_VkFragmentShadingRateNV.VK_FRAGMENT_SHADING_RATE_1_INVOCATION_PER_4X2_PIXELS_NV);
pub const VK_FRAGMENT_SHADING_RATE_1_INVOCATION_PER_4X4_PIXELS_NV = @enumToInt(enum_VkFragmentShadingRateNV.VK_FRAGMENT_SHADING_RATE_1_INVOCATION_PER_4X4_PIXELS_NV);
pub const VK_FRAGMENT_SHADING_RATE_2_INVOCATIONS_PER_PIXEL_NV = @enumToInt(enum_VkFragmentShadingRateNV.VK_FRAGMENT_SHADING_RATE_2_INVOCATIONS_PER_PIXEL_NV);
pub const VK_FRAGMENT_SHADING_RATE_4_INVOCATIONS_PER_PIXEL_NV = @enumToInt(enum_VkFragmentShadingRateNV.VK_FRAGMENT_SHADING_RATE_4_INVOCATIONS_PER_PIXEL_NV);
pub const VK_FRAGMENT_SHADING_RATE_8_INVOCATIONS_PER_PIXEL_NV = @enumToInt(enum_VkFragmentShadingRateNV.VK_FRAGMENT_SHADING_RATE_8_INVOCATIONS_PER_PIXEL_NV);
pub const VK_FRAGMENT_SHADING_RATE_16_INVOCATIONS_PER_PIXEL_NV = @enumToInt(enum_VkFragmentShadingRateNV.VK_FRAGMENT_SHADING_RATE_16_INVOCATIONS_PER_PIXEL_NV);
pub const VK_FRAGMENT_SHADING_RATE_NO_INVOCATIONS_NV = @enumToInt(enum_VkFragmentShadingRateNV.VK_FRAGMENT_SHADING_RATE_NO_INVOCATIONS_NV);
pub const VK_FRAGMENT_SHADING_RATE_MAX_ENUM_NV = @enumToInt(enum_VkFragmentShadingRateNV.VK_FRAGMENT_SHADING_RATE_MAX_ENUM_NV);
pub const enum_VkFragmentShadingRateNV = extern enum(c_int) {
...
pub const VK_BUILD_ACCELERATION_STRUCTURE_MODE_BUILD_KHR = @enumToInt(enum_VkBuildAccelerationStructureModeKHR.VK_BUILD_ACCELERATION_STRUCTURE_MODE_BUILD_KHR);
pub const VK_BUILD_ACCELERATION_STRUCTURE_MODE_UPDATE_KHR = @enumToInt(enum_VkBuildAccelerationStructureModeKHR.VK_BUILD_ACCELERATION_STRUCTURE_MODE_UPDATE_KHR);
pub const VK_BUILD_ACCELERATION_STRUCTURE_MODE_MAX_ENUM_KHR = @enumToInt(enum_VkBuildAccelerationStructureModeKHR.VK_BUILD_ACCELERATION_STRUCTURE_MODE_MAX_ENUM_KHR);
pub const enum_VkBuildAccelerationStructureModeKHR = extern enum(c_int) {
...
pub const VK_ACCELERATION_STRUCTURE_BUILD_TYPE_HOST_KHR = @enumToInt(enum_VkAccelerationStructureBuildTypeKHR.VK_ACCELERATION_STRUCTURE_BUILD_TYPE_HOST_KHR);
pub const VK_ACCELERATION_STRUCTURE_BUILD_TYPE_DEVICE_KHR = @enumToInt(enum_VkAccelerationStructureBuildTypeKHR.VK_ACCELERATION_STRUCTURE_BUILD_TYPE_DEVICE_KHR);
pub const VK_ACCELERATION_STRUCTURE_BUILD_TYPE_HOST_OR_DEVICE_KHR = @enumToInt(enum_VkAccelerationStructureBuildTypeKHR.VK_ACCELERATION_STRUCTURE_BUILD_TYPE_HOST_OR_DEVICE_KHR);
pub const VK_ACCELERATION_STRUCTURE_BUILD_TYPE_MAX_ENUM_KHR = @enumToInt(enum_VkAccelerationStructureBuildTypeKHR.VK_ACCELERATION_STRUCTURE_BUILD_TYPE_MAX_ENUM_KHR);
pub const enum_VkAccelerationStructureBuildTypeKHR = extern enum(c_int) {
...
pub const VK_ACCELERATION_STRUCTURE_COMPATIBILITY_COMPATIBLE_KHR = @enumToInt(enum_VkAccelerationStructureCompatibilityKHR.VK_ACCELERATION_STRUCTURE_COMPATIBILITY_COMPATIBLE_KHR);
pub const VK_ACCELERATION_STRUCTURE_COMPATIBILITY_INCOMPATIBLE_KHR = @enumToInt(enum_VkAccelerationStructureCompatibilityKHR.VK_ACCELERATION_STRUCTURE_COMPATIBILITY_INCOMPATIBLE_KHR);
pub const VK_ACCELERATION_STRUCTURE_COMPATIBILITY_MAX_ENUM_KHR = @enumToInt(enum_VkAccelerationStructureCompatibilityKHR.VK_ACCELERATION_STRUCTURE_COMPATIBILITY_MAX_ENUM_KHR);
pub const enum_VkAccelerationStructureCompatibilityKHR = extern enum(c_int) {
...
pub const VK_ACCELERATION_STRUCTURE_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR = @enumToInt(enum_VkAccelerationStructureCreateFlagBitsKHR.VK_ACCELERATION_STRUCTURE_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR);
pub const VK_ACCELERATION_STRUCTURE_CREATE_FLAG_BITS_MAX_ENUM_KHR = @enumToInt(enum_VkAccelerationStructureCreateFlagBitsKHR.VK_ACCELERATION_STRUCTURE_CREATE_FLAG_BITS_MAX_ENUM_KHR);
pub const enum_VkAccelerationStructureCreateFlagBitsKHR = extern enum(c_int) {
...
pub const PFN_vkCreateAccelerationStructureKHR = ?fn (VkDevice, [*c]const VkAccelerationStructureCreateInfoKHR, [*c]const VkAllocationCallbacks, [*c]VkAccelerationStructureKHR) callconv(.C) VkResult;
...
pub const PFN_vkCmdBuildAccelerationStructuresIndirectKHR = ?fn (VkCommandBuffer, u32, [*c]const VkAccelerationStructureBuildGeometryInfoKHR, [*c]const VkDeviceAddress, [*c]const u32, [*c]const [*c]const u32) callconv(.C) void;
pub const PFN_vkBuildAccelerationStructuresKHR = ?fn (VkDevice, VkDeferredOperationKHR, u32, [*c]const VkAccelerationStructureBuildGeometryInfoKHR, [*c]const [*c]const VkAccelerationStructureBuildRangeInfoKHR) callconv(.C) VkResult;
pub const PFN_vkCopyAccelerationStructureKHR = ?fn (VkDevice, VkDeferredOperationKHR, [*c]const VkCopyAccelerationStructureInfoKHR) callconv(.C) VkResult;
pub const PFN_vkCopyAccelerationStructureToMemoryKHR = ?fn (VkDevice, VkDeferredOperationKHR, [*c]const VkCopyAccelerationStructureToMemoryInfoKHR) callconv(.C) VkResult;
pub const PFN_vkCopyMemoryToAccelerationStructureKHR = ?fn (VkDevice, VkDeferredOperationKHR, [*c]const VkCopyMemoryToAccelerationStructureInfoKHR) callconv(.C) VkResult;
pub const PFN_vkWriteAccelerationStructuresPropertiesKHR = ?fn (VkDevice, u32, [*c]const VkAccelerationStructureKHR, VkQueryType, usize, ?*c_void, usize) callconv(.C) VkResult;
...
pub const PFN_vkGetAccelerationStructureDeviceAddressKHR = ?fn (VkDevice, [*c]const VkAccelerationStructureDeviceAddressInfoKHR) callconv(.C) VkDeviceAddress;
...
pub const PFN_vkGetDeviceAccelerationStructureCompatibilityKHR = ?fn (VkDevice, [*c]const VkAccelerationStructureVersionInfoKHR, [*c]VkAccelerationStructureCompatibilityKHR) callconv(.C) void;
pub const PFN_vkGetAccelerationStructureBuildSizesKHR = ?fn (VkDevice, VkAccelerationStructureBuildTypeKHR, [*c]const VkAccelerationStructureBuildGeometryInfoKHR, [*c]const u32, [*c]VkAccelerationStructureBuildSizesInfoKHR) callconv(.C) void;
...
pub extern fn vkWriteAccelerationStructuresPropertiesKHR(device: VkDevice, accelerationStructureCount: u32, pAccelerationStructures: [*c]const VkAccelerationStructureKHR, queryType: VkQueryType, dataSize: usize, pData: ?*c_void, stride: usize) VkResult;
...
pub const VK_SHADER_GROUP_SHADER_GENERAL_KHR = @enumToInt(enum_VkShaderGroupShaderKHR.VK_SHADER_GROUP_SHADER_GENERAL_KHR);
pub const VK_SHADER_GROUP_SHADER_CLOSEST_HIT_KHR = @enumToInt(enum_VkShaderGroupShaderKHR.VK_SHADER_GROUP_SHADER_CLOSEST_HIT_KHR);
pub const VK_SHADER_GROUP_SHADER_ANY_HIT_KHR = @enumToInt(enum_VkShaderGroupShaderKHR.VK_SHADER_GROUP_SHADER_ANY_HIT_KHR);
pub const VK_SHADER_GROUP_SHADER_INTERSECTION_KHR = @enumToInt(enum_VkShaderGroupShaderKHR.VK_SHADER_GROUP_SHADER_INTERSECTION_KHR);
pub const VK_SHADER_GROUP_SHADER_MAX_ENUM_KHR = @enumToInt(enum_VkShaderGroupShaderKHR.VK_SHADER_GROUP_SHADER_MAX_ENUM_KHR);
pub const enum_VkShaderGroupShaderKHR = extern enum(c_int) {
...
pub const PFN_vkCreateRayTracingPipelinesKHR = ?fn (VkDevice, VkDeferredOperationKHR, VkPipelineCache, u32, [*c]const VkRayTracingPipelineCreateInfoKHR, [*c]const VkAllocationCallbacks, [*c]VkPipeline) callconv(.C) VkResult;
pub const PFN_vkGetRayTracingCaptureReplayShaderGroupHandlesKHR = ?fn (VkDevice, VkPipeline, u32, u32, usize, ?*c_void) callconv(.C) VkResult;
pub const PFN_vkCmdTraceRaysIndirectKHR = ?fn (VkCommandBuffer, [*c]const VkStridedDeviceAddressRegionKHR, [*c]const VkStridedDeviceAddressRegionKHR, [*c]const VkStridedDeviceAddressRegionKHR, [*c]const VkStridedDeviceAddressRegionKHR, VkDeviceAddress) callconv(.C) void;
pub const PFN_vkGetRayTracingShaderGroupStackSizeKHR = ?fn (VkDevice, VkPipeline, u32, VkShaderGroupShaderKHR) callconv(.C) VkDeviceSize;
...
pub extern fn vkGetRayTracingCaptureReplayShaderGroupHandlesKHR(device: VkDevice, pipeline: VkPipeline, firstGroup: u32, groupCount: u32, dataSize: usize, pData: ?*c_void) VkResult;
...
pub const __stdint_join3 = @compileError("unable to translate C expr: unexpected token .HashHash"); // c:\zig-windows-x86_64-0.8.0-dev.876+95e66a915\lib\zig\include\stdint.h:245:9
pub const __int_c_join = @compileError("unable to translate C expr: unexpected token .HashHash"); // c:\zig-windows-x86_64-0.8.0-dev.876+95e66a915\lib\zig\include\stdint.h:282:9
pub const __uint_c = @compileError("unable to translate C expr: expected ',' or ')'"); // c:\zig-windows-x86_64-0.8.0-dev.876+95e66a915\lib\zig\include\stdint.h:284:9
pub const VK_DEFINE_HANDLE = @compileError("unable to translate C expr: unexpected token .Keyword_typedef"); // c:/VulkanSDK/1.2.162.0/Include\vulkan/vulkan_core.h:25:9
pub const VK_DEFINE_NON_DISPATCHABLE_HANDLE = @compileError("unable to translate C expr: unexpected token .Keyword_typedef"); // c:/VulkanSDK/1.2.162.0/Include\vulkan/vulkan_core.h:30:17
...
pub fn VK_MAKE_VERSION(major: anytype, minor: anytype, patch: anytype) callconv(.Inline) @TypeOf((((@import("std").meta.cast(u32, major)) << 22) | ((@import("std").meta.cast(u32, minor)) << 12)) | (@import("std").meta.cast(u32, patch))) {
...
pub const VK_HEADER_VERSION = 162;
pub const VK_HEADER_VERSION_COMPLETE = VK_MAKE_VERSION(1, 2, VK_HEADER_VERSION);
pub fn VK_VERSION_MAJOR(version: anytype) callconv(.Inline) @TypeOf((@import("std").meta.cast(u32, version)) >> 22) {
    return (@import("std").meta.cast(u32, version)) >> 22;
}
pub fn VK_VERSION_MINOR(version: anytype) callconv(.Inline) @TypeOf(((@import("std").meta.cast(u32, version)) >> 12) & 0x3ff) {
    return ((@import("std").meta.cast(u32, version)) >> 12) & 0x3ff;
}
pub fn VK_VERSION_PATCH(version: anytype) callconv(.Inline) @TypeOf((@import("std").meta.cast(u32, version)) & 0xfff) {
...
pub const VK_KHR_shader_terminate_invocation = 1;
pub const VK_KHR_SHADER_TERMINATE_INVOCATION_SPEC_VERSION = 1;
pub const VK_KHR_SHADER_TERMINATE_INVOCATION_EXTENSION_NAME = "VK_KHR_shader_terminate_invocation";
pub const VK_KHR_fragment_shading_rate = 1;
pub const VK_KHR_FRAGMENT_SHADING_RATE_SPEC_VERSION = 1;
...
pub const VK_KHR_deferred_host_operations = 1;
pub const VK_KHR_DEFERRED_HOST_OPERATIONS_SPEC_VERSION = 4;
...
pub const VK_KHR_pipeline_library = 1;
pub const VK_KHR_PIPELINE_LIBRARY_SPEC_VERSION = 1;
...
pub const VK_KHR_copy_commands2 = 1;
pub const VK_KHR_COPY_COMMANDS_2_SPEC_VERSION = 1;
...
pub const VK_EXT_shader_image_atomic_int64 = 1;
pub const VK_EXT_SHADER_IMAGE_ATOMIC_INT64_SPEC_VERSION = 1;
...
pub const VK_EXT_VALIDATION_FEATURES_SPEC_VERSION = 4;
...
pub const VK_EXT_device_memory_report = 1;
pub const VK_EXT_DEVICE_MEMORY_REPORT_SPEC_VERSION = 1;
...
pub const VK_NV_fragment_shading_rate_enums = 1;
pub const VK_NV_FRAGMENT_SHADING_RATE_ENUMS_SPEC_VERSION = 1;
...
pub const VK_QCOM_rotated_copy_commands = 1;
pub const VK_QCOM_rotated_copy_commands_SPEC_VERSION = 0;
...
pub const VK_EXT_4444_formats = 1;
pub const VK_EXT_4444_FORMATS_SPEC_VERSION = 1;
pub const VK_EXT_4444_FORMATS_EXTENSION_NAME = "VK_EXT_4444_formats";
pub const VK_KHR_acceleration_structure = 1;
pub const VK_KHR_ACCELERATION_STRUCTURE_SPEC_VERSION = 11;
pub const VK_KHR_ACCELERATION_STRUCTURE_EXTENSION_NAME = "VK_KHR_acceleration_structure";
pub const VK_KHR_ray_tracing_pipeline = 1;
pub const VK_KHR_RAY_TRACING_PIPELINE_SPEC_VERSION = 1;
pub const VK_KHR_RAY_TRACING_PIPELINE_EXTENSION_NAME = "VK_KHR_ray_tracing_pipeline";
pub const VK_KHR_ray_query = 1;
pub const VK_KHR_RAY_QUERY_SPEC_VERSION = 1;
